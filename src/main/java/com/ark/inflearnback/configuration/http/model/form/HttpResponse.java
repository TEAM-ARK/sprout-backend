package com.ark.inflearnback.configuration.http.model.form;
...
public class HttpResponse<T> {
    ...
    public static <T> HttpResponse<T> of(final HttpStatus httpStatus, final T responseBody) {
        return new HttpResponse<>(parseStr(httpStatus.value()), httpStatus.getReasonPhrase(), responseBody);
    }
